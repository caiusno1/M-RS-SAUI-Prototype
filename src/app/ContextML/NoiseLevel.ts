...
export class NoiseLevel extends ContextProperty{
  public type = 'NoiseLevel';
  public eClass: string;
  public $ref: string;
  
  // Type: ecore:EDataType http://www.eclipse.org/emf/2002/Ecore#//EDouble
  public value: EDouble;
